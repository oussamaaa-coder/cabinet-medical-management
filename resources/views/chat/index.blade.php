...
<div class="chat-container">
    <div class="chat-header">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width: 24px; color: #2563eb;">
    ...
    <div class="chat-footer">
        <form id="chat-form" class="message-form">
            @csrf
            <input type="text" id="message-input" name="content" class="message-input" placeholder="Tapez votre message ici..." autocomplete="off">
