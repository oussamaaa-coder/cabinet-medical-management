...
@section('content')
  ...
  <svg xmlns="http://www.w3.org/2000/svg" style="display:none">
    <symbol id="icon-user" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
    ...
    <symbol id="icon-plus" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
      stroke-linejoin="round">
      <circle cx="12" cy="12" r="10" />
      <line x1="12" y1="8" x2="12" y2="16" />
      <line x1="8" y1="12" x2="16" y2="12" />
    </symbol>
    <symbol id="icon-admin" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
      stroke-linejoin="round">
      <rect x="3" y="11" width="18" height="11" rx="2" />
      <path d="M7 11V7a5 5 0 0 1 10 0v4" />
    </symbol>
    <symbol id="icon-doctor" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
      stroke-linejoin="round">
      <polyline points="22 12 18 12 15 21 9 3 6 12 2 12" />
    </symbol>
    <symbol id="icon-nurse" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
      stroke-linejoin="round">
      <line x1="12" y1="5" x2="12" y2="19" />
      <line x1="5" y1="12" x2="19" y2="12" />
    </symbol>
    <symbol id="icon-secretary" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
      stroke-linecap="round" stroke-linejoin="round">
      ...
      <div class="form-card">
        ...
        <div class="form-card-header">
          ...
          <div>
            ...
            <div class="form-card-subtitle">Remplissez les informations pour ajouter un nouvel utilisateur au système
            </div>
          </div>
        </div>
          ...
          <div class="form-card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" name="name" class="form-input {{ $errors->has('name') ? 'error' : '' }}"
                placeholder="Ex: Dr. Mohamed Alaoui" value="{{ old('name') }}" required>
              @error('name')
                <div class="form-error"><svg>
                    <use href="#icon-warning" />
                  </svg>{{ $message }}</div>
              @enderror
            </div>
            ...
            <div class="form-group">
              ...
              <input type="email" name="email" class="form-input {{ $errors->has('email') ? 'error' : '' }}"
                placeholder="exemple@medical.ma" value="{{ old('email') }}" required>
              @error('email')
                <div class="form-error"><svg>
                    <use href="#icon-warning" />
                  </svg>{{ $message }}</div>
            ...
            <div class="form-group" id="phone-group">
              ...
              <input type="text" name="phone" id="phone" class="form-input {{ $errors->has('phone') ? 'error' : '' }}"
                placeholder="Ex: 0612345678" value="{{ old('phone') }}">
              @error('phone')
                <div class="form-error"><svg>
                    <use href="#icon-warning" />
                  </svg>{{ $message }}</div>
            ...
            <div class="form-group" id="specialty-group" style="display: none;">
              ...
              <input type="text" name="specialty" id="specialty"
                class="form-input {{ $errors->has('specialty') ? 'error' : '' }}" placeholder="Ex: Cardiologue"
                value="{{ old('specialty') }}">
              @error('specialty')
                <div class="form-error"><svg>
                    <use href="#icon-warning" />
              ...
              <div class="role-options">
                ...
                <label class="role-option">
                  ...
                  <div class="role-option-card">
                    <span class="role-option-icon"><svg>
                        <use href="#icon-admin" />
                      </svg></span>
                    <div>
