...
<div class="doctors-page-wrapper">
    ...
    <div class="app-topbar">
        <div class="app-breadcrumb">
            ...
            <a href="{{ route('doctors.show', $doctor->id) }}">Dr. {{ $doctor->last_name }} {{ $doctor->first_name }}</a>
            <span class="sep">
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"/></svg>
            </span>
    ...
    <div class="app-card" style="max-width: 680px; margin: 0 auto;">
        <div style="margin-bottom: 28px; border-bottom: 1px solid var(--border); padding-bottom: 20px;">
            <h3 style="margin: 0; font-size: 1.25rem; font-weight: 700; color: var(--text-primary);">Modifier le profil du médecin</h3>
            <p style="margin: 4px 0 0; font-size: 0.875rem; color: var(--text-muted);">
                Dr. {{ $doctor->last_name }} {{ $doctor->first_name }} &mdash; {{ $doctor->specialty }}
            </p>
        </div>

        @if(session('success'))
            <div style="background: #d1fae5; border: 1px solid #6ee7b7; border-radius: 10px; padding: 14px 18px; margin-bottom: 24px; color: #065f46; font-size: 0.875rem;">
                {{ session('success') }}
            </div>
        @endif
        ...
        <form action="{{ route('doctors.update', $doctor->id) }}" method="POST">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                <div>
                    ...
                    <input type="text" name="first_name" class="app-form-control"
                ...
                <div>
                    ...
                    <input type="text" name="last_name" class="app-form-control"
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 28px;">
                ...
                <div>
                    ...
                    <input type="email" name="email" class="app-form-control"
                           ...
                           placeholder="ex: docteur@mail.com" required>
                </div>
            </div>

            <div style="margin-bottom: 28px;">
                <label class="app-form-label">Mot de passe de connexion <span style="color:#ef4444">*</span></label>
                <input type="text" name="password" class="app-form-control"
                       value="{{ old('password', $doctor->plain_password) }}"
                       placeholder="Mot de passe">
            </div>

            <div style="display: flex; gap: 12px; justify-content: flex-end;">
                <a href="{{ route('doctors.show', $doctor->id) }}" class="app-btn app-btn-secondary">Annuler</a>
